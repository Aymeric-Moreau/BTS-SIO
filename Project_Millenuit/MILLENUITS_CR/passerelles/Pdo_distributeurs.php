...
class Pdo_Distributeurs {
    ...
    public static function getDistributeursSansCR() {
        ...
        try {
            ...
            $req = "SELECT raison_sociale, adresse_l1 "
                    . "FROM distributeur "
                    . "WHERE id NOT IN (SELECT id_distributeur FROM compte_rendu_visite WHERE date_visite <= '{$date->format('Y-m-d')}' )";
