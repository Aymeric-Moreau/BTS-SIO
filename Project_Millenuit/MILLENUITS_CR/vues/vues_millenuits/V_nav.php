                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav_item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownCompteRendus">
                            ...
                            <li><a class="dropdown-item" href="index.php?uc=compte_rendu&action=afficher_cr">Aficher les comptes-rendu</a></li>
                            <li><a class="dropdown-item" href="index.php?uc=compte_rendu&action=sans_visite">Aficher les distributeur sans visite</a></li>
                        </ul>  
                    </li>
                    <li class="nav_item dropdown">
                        <a class ="nav-link dropdown-toggle" href="#"
