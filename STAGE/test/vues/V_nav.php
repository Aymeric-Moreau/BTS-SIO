        ...
        <!-- Fonctionnalités de la barre de navigation -->
         <div class="navbar-nav collapse navbar-collapse navbar-brand ms-auto" id="menu">
            ...
            <ul class="navbar-nav nav-pills">
                ...
                <!-- Menu déroulant "Les sports" -->
                <li class="nav_item dropdown">
                    <a class ="nav-link dropdown-toggle" href="#"
                       id="navbarDropdownSport" data-bs-toggle="dropdown">Les sports</a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownSport">
                        ...
                        <li><a class="dropdown-item" href="index.php?uc=sport_co&action=football">Football</a></li>
            ...
            <!-- Affichage du nom de l'utilisateur connecté ou lien de connexion -->
            <?php
            if (isset($_SESSION["login"])) {
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item" >
                        <a class="nav-link" href="index.php?uc=authentification&action=se_deconnecter"> Se déconnecter
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <button type="button" class="btn " href="index.php?uc=authentification&action=se_connecter" id="se_connecter">Se connecter</button>
                    </li>
                </ul>
                <?php
            }
