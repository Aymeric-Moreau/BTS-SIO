    ...
    <div class="row">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="card cc">
                            ...
                            <form action="index.php?uc=sport_raquette&action=formt" method="post">
        ...
        <div class="col-md-5">
            <div class="map">
                    ...
                    <div class="d-flex flex-column align-items-start gap-3 custom-container">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                ...
                                <div class="custom-text">Christophe AUBIN</div>
                            </div>
                        </div>
                        <div class="d-flex align-items-start gap-3">
                            <div class="position-relative custom-circle">
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                ...
                                <div class="custom-text">christophe2.aubin@gmail.com</div>
                            </div>
                        </div>
                        <div class="d-flex align-items-start gap-3">
                            <div class="position-relative custom-circle">
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                ...
                                <div class="custom-text">06.30.06.41.19</div>
                            </div>
                        </div>
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2706.4611184449777!2d0.1606520763748866!3d47.285787771162255!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47fd5aacd33309e3%3A0x9a99e821b19a5059!2sTennis-Club%20de%20Bourgueil!5e0!3m2!1sfr!2sfr!4v1693342953444!5m2!1sfr!2sfr"
