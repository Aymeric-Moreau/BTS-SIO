                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="card cc">
                            ...
                            <form action="index.php?uc=petanque&action=form" method="post">
                    ...
                    <div class="d-flex flex-column align-items-start gap-3 custom-container">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                ...
                                <div class="custom-text">Erwan BRETAUDIERE</div>
                            </div>
                        </div>
                        <div class="d-flex align-items-start gap-3">
                            <div class="position-relative custom-circle">
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                ...
                                <div class="custom-text">petanquebourgueil@gmail.com</div>
                            </div>
                        </div>
                        <div class="d-flex align-items-start gap-3">
                            <div class="position-relative custom-circle">
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                ...
                                <div class="custom-text">06.60.96.03.65</div>
                            </div>
                        </div>

                    </div>
                </div>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2706.616884655093!2d0.16005597637473254!3d47.28274327116202!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47fd45492a2fdc99%3A0x6d606d3523df7dad!2sBoulodrome%20Entente%20Sportive%20Bourgueil!5e0!3m2!1sfr!2sfr!4v1693167912623!5m2!1sfr!2sfr"
