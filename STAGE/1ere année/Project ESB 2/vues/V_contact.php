            ...
            <div class="map">
                <div class="container">
                    <div class="d-flex flex-column align-items-start gap-3 custom-container">
                        <!-- Zone prévue pour accueillir l'icône et le texte -->
                        <div class="d-flex align-items-start gap-3">
                            <div class="position-relative custom-circle">
                                <!-- Rond bleu placé derrière l'icône-->
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                ...
                                <!-- information -->
                                <div class="custom-text">exemple@mail.com</div>
                            </div>
                        </div>
                        <div class="d-flex align-items-start gap-3">
                            <div class="position-relative custom-circle">
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                ...
                                <div class="custom-text">06 60 06 60 37</div>
                            </div>
                        </div>
                        <div class="d-flex align-items-start gap-3">
                            <div class="position-relative custom-circle">
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                ...
                                <div class="custom-text">4 rue du sport, quelque part vers Bourgueil</div>
                            </div>
                        </div>
                    </div>
                </div>
