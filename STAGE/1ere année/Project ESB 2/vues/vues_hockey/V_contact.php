                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="card cc">
                            ...
                            <form action="index.php?uc=sport_co&action=formh" method="post">
                    ...
                    <div class="d-flex flex-column align-items-start gap-3 custom-container">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                ...
                                <div class="custom-text">Laurence PRIETO</div>
                            </div>
                        </div>
                        <div class="d-flex align-items-start gap-3">
                            <div class="position-relative custom-circle">
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                ...
                                <div class="custom-text">esbhockeysurglace@gmail.com</div>
                            </div>
                        </div>
                        <div class="d-flex align-items-start gap-3">
                            <div class="position-relative custom-circle">
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                ...
                                <div class="custom-text">07.86.26.08.64</div>
                            </div>
                        </div>

                    </div>
                </div>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2706.5055237215784!2d0.17054147637484326!3d47.28491987116209!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47fd455a79e96b25%3A0xe8931416339d3f1d!2sPatinoire%20de%20Bourgueil!5e0!3m2!1sfr!2sfr!4v1692911931274!5m2!1sfr!2sfr"
