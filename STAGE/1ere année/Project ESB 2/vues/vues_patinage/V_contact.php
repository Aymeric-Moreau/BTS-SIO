                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="card cc">
                            ...
                            <form action="index.php?uc=sport_glisse&action=formp" method="post">
                    ...
                    <div class="d-flex flex-column align-items-start gap-3 custom-container">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                ...
                                <div class="custom-text">Maguy ROINE</div>
                            </div>
                        </div>
                        <div class="d-flex align-items-start gap-3">
                            <div class="position-relative custom-circle">
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                ...
                                <div class="custom-text">esbpatinage@yahoo.com</div>
                            </div>
                        </div>
                        <div class="d-flex align-items-start gap-3">
                            <div class="position-relative custom-circle">
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                ...
                                <div class="custom-text">06.99.46.18.05</div>
                            </div>
                        </div>
